...
var assets = func() http.FileSystem {
	...
	fs := _vfsgen_fs{
		"/": &_vfsgen_dirInfo{
			name:    "/",
			modTime: mustUnmarshalTextTime("2015-04-25T14:41:07-07:00"),
		},
		"/repo.html.tmpl": &_vfsgen_compressedFileInfo{
			name:              "repo.html.tmpl",
			...
			modTime:           mustUnmarshalTextTime("2015-04-25T14:16:50-07:00"),
		},
		"/script.js": &_vfsgen_compressedFileInfo{
			name:              "script.js",
		...
		"/style.css": &_vfsgen_compressedFileInfo{
			name:              "style.css",
			...
			modTime:           mustUnmarshalTextTime("2015-04-25T15:26:39-07:00"),
		},
	}

	fs["/"].(*_vfsgen_dirInfo).entries = []os.FileInfo{
		fs["/repo.html.tmpl"].(os.FileInfo),
		fs["/script.js"].(os.FileInfo),
